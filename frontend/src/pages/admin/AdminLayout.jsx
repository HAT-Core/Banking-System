      ...
      <Box sx={{ flex: 1, marginLeft: '280px', display: 'flex', flexDirection: 'column', position: 'relative', zIndex: 10 }}>
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, background: 'rgba(74,222,128,0.1)', px: 2, py: 0.8, borderRadius: '100px', border: '1px solid rgba(74,222,128,0.2)' }}>
              <Box sx={{ width: 8, height: 8, borderRadius: '50%', background: '#4ADE80', boxShadow: '0 0 12px #4ADE80', animation: 'pulse 2s infinite', '@keyframes pulse': { '0%, 100%': { opacity: 1 }, '50%': { opacity: 0.4 } } }} />
              <Typography sx={{ fontSize: 12, color: '#4ADE80', fontWeight: 600, letterSpacing: 0.5 }}>System Secure</Typography>
            </Box>
            
            <Box sx={{ width: 1, height: 24, background: 'rgba(255,255,255,0.1)' }} />
            
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, cursor: 'pointer', '&:hover .MuiTypography-root': { color: '#60A5FA' } }}>
              <Box sx={{ textAlign: 'right' }}>
                <Typography sx={{ fontSize: 14, color: '#fff', fontWeight: 700, transition: 'color 0.2s' }}>Alex Mercer</Typography>
                <Typography sx={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>Lead Administrator</Typography>
              </Box>
              <Avatar sx={{ width: 42, height: 42, background: '#60A5FA', color: '#0A0A0A', fontWeight: 800, border: '2px solid rgba(96,165,250,0.3)' }}>
                AM
              </Avatar>
            </Box>
          </Box>
